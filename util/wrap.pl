...
BEGIN {
    ...
    require '/usr/home/ngie/git/freebsd-src/worktree/vendor/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/usr/home/ngie/git/freebsd-src/worktree/vendor/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/usr/home/ngie/git/freebsd-src/worktree/vendor/test/default-and-jitter.cnf';
    shift;
